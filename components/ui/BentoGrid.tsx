  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(50,50,62,1) 35%, rgba(0,212,255,1) 100%)'
      }}
    >
      <div className={`${id === 6} && 'flex justify-center h-full`}>
        ...
        <div className={`absolute right-0 -bottom-5 ${id === 5 && 'w-full opacity-80  '}`}>{spareImg && (
